...
const Main = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="text-xl font-bold text-gray-900">Kevin Kirui</div>
      ...
      <section
        id="home"
        className="min-h-screen flex items-center pt-12 justify-center relative "
      >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Tools and methods I rely on to solve problems and ship great
              software
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 rounded-lg hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Experience working with cross-functional teams and agile
                methodologies
              </p>
            </div>
            <div className="text-center p-6 rounded-lg hover:shadow-lg transition-shadow">
          ...
          <div className="space-y-12">
            ...
            <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Worked on the backend development of a roster management system.
                Responsible for creating APIs to fetch and serve data for the
                roster page, as well as implementing functionality to ensure
                that data is properly stored and maintained in the database.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                As a freelance web developer, I designed and built websites for
                small businesses and private clients across various industries.
                I handled projects end-to-end, from initial consultations and
                design mockups to development, deployment, and post-launch
                support.
              </p>
            </div>
          </div>
            ...
            >
              <div className="relative w-full aspect-video">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-20 flex items-center justify-center transition-opacity duration-300">
                  <div
                    style={{ paddingTop: "30%" }}
                    className="text-white text-left p-4  max-w-full"
                  >
                    <p className="text-lg sm:text-xl font-bold opacity-90">
                      Riverside Hostel Managment System
                    </p>
                    <p className="text-xs sm:text-sm opacity-90 mt-1 leading-tight">
                     About
This is a Managment System for Riverside that stores info for tenant and admin is able to edit any changes. Tenants are able to view their remaining rent balance and raise issue from their login page if room has an issue
                    </p>
            ...
            >
              <div className="relative w-full aspect-video">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-20 flex items-left p-5 justify-left transition-opacity duration-300">
                  <div style={{ paddingTop: "30%" }} className="text-white text-left   max-w-full">
                    <p className="text-lg sm:text-xl font-bold opacity-90">
                      GameXchange
                    </p>
                    <p className="text-xs sm:text-sm opacity-90 mt-1 leading-tight">
                      An E-commerce website for video games exchange between
                      buyers (Gamer) and sellers managed by the admin
                    </p>
                    <button className="bg-gray-100 hover:bg-gray-700 text-white py-1.5 px-3 sm:py-2 sm:px-4 rounded mt-2 text-xs sm:text-sm">
            ...
            >
              <div style={{ textAlign: "center" }} className="relative  w-42 aspect-video">
                <video
                ...
                <div className="absolute inset-0 bg-black bg-opacity-20 flex items-left justify-left transition-opacity duration-300">
                  <div
                    style={{ paddingTop: "20%" }}
                    className="text-white text-left p-4  max-w-92"
                  >
                    <p className="text-lg sm:text-xl font-bold opacity-90">
                      Chai App
                    </p>
            ...
            >
              <div style={{ width: "100%" }} className="   ">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-20 flex items-left justify-left transition-opacity duration-300">
                  <div style={{ paddingTop: "40%" }} className="text-white text-left p-4 max-w-full">
                    <p className="text-lg sm:text-xl font-bold opacity-90">
                      Cheffset Restaurant{" "}
                    </p>
                    <p className="text-xs sm:text-sm opacity-90 mt-1 leading-tight">
                      Static Website of a Restaurant known as Cheffset
                      Displaying its Menu and its Services.
                    </p>
                    <div className="flex flex-wrap gap-2 mt-2">
                      <button className="bg-gray-100 hover:bg-gray-700 text-white py-1.5 px-3 sm:py-2 sm:px-4 rounded text-xs sm:text-sm">
                        <span className="text-blue-500">React</span>
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div id="skills" className="text-center mb-16">
            <h2 className="text-4xl border-b-4 p-2 w-1/4 mx-auto border-indigo-500  font-bold mb-4">
              Skills
            </h2>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              <h3 className="text-2xl  border-l-4 p-2 w-1/4 border-indigo-500  font-bold text-gray-900 mb-6 text-center">
                Programming Languages
              </h3>
            ...
            <div className="bg-white	 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="flex flex-col items-center p-3 rounded-lg hover:bg-gray-50 transition-colors">
                  <img
                    className="w-12 h-12 mb-2"
                    src="https://th.bing.com/th/id/R.b3b644aa4995aee815fb831d715c4c68?rik=xmFh2anLSp0SDQ&pid"
                    alt="Laravel"
                  />
